COURSE_ACTS(COURSE_BOB, _(" 1 BOB-OMB BIELEFELD"),
       _("BIG BOB-OMB ON THE SUMMIT")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("GOBBLE WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_HMC, _(" 6 HAZY MAZE CAVE"),
       _("SWIMMING BEAST IN THE CAVERN")  , _("ELEVATE FOR 8 RED COINS")       , _("METAL-HEAD GOBBLE CAN MOVE!"),
...
SECRET_STAR(COURSE_WMOTR, _("   WING GOBBLE OVER THE RAINBOW"))
